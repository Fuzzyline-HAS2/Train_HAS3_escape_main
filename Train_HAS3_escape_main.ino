 /**
 * @file Train_HAS3_escape_main.ino
...
//    has2wifi.Setup("city");
    ...
    ota.setPartitionUpdate(
        "https://raw.githubusercontent.com/Fuzzyline-HAS2/Train_HAS3_escape_main/third_store/partitions.bin",
        "https://raw.githubusercontent.com/Fuzzyline-HAS2/Train_HAS3_escape_main/third_store/partitions.sig",
        "https://raw.githubusercontent.com/Fuzzyline-HAS2/Train_HAS3_escape_main/third_store/partition_version.txt",
        PARTITION_VER
    );
    TelnetInit();
    NeopixelInit();
